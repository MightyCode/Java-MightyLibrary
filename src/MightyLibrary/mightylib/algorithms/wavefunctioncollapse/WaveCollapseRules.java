...
public class WaveCollapseRules extends DataType {
    ...
    public WaveCollapseRules(String dataName) {
        super(TYPE_SET_UP.THREAD_CONTEXT, dataName);
    }
    ...
    public void setData(JSONFile jsonFile) {
        if (isLoaded())
            throw new RuntimeException("Data already loaded");
    ...
    public void parseListIdTypeFile(){
        JSONObject root = data.getObject();
