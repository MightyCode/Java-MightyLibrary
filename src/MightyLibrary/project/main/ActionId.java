...
public class ActionId {
    ...
    public static final int MOVE_RIGHT_2D = InputManager.getAndIncrementId();
    public static final int MOVE_LEFT_2D = InputManager.getAndIncrementId();
    public static final int MOVE_UP_2D = InputManager.getAndIncrementId();
    public static final int MOVE_DOWN_2D = InputManager.getAndIncrementId();
    ...
    public static final int TAB = InputManager.getAndIncrementId();
